...
public class Assignments115 {
	...
	public Object[][] method1(){
		...
		data[2][0]="Surya";
		data[2][1]="Kumar";
		data[2][2]="Surya@hmail.com";
		data[2][3]="qwe";
		data[2][4]="56, Area 10 ,villa ,PJ";
		data[2][5]="56, Area 10 ,villa ,PJ";
		data[2][6]="876984";
	...
	@Test(priority = 2)
    public void testAlertValidation() {
        
        Alert alert = driver.switchTo().alert();
        String alertText = alert.getText();
        System.out.println("alert massage"+alertText);
//        Assert.assertEquals(alertText, "Ok", "Alert text does not match the expected value.");
       alert.accept(); 
    }
}
